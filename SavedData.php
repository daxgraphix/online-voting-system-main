...
$sqlCheck = "SELECT * FROM users WHERE email = :email OR number = :number OR rollno = :rollno";
...
if ($existingVote) {
    ...
    echo "<script>alert('You have already voted.'); window.location.href = 'validation_user.php';</script>";
