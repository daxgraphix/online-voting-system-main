...
$sql_check = "SELECT * FROM candidate_2nd WHERE email = :email OR mobile = :mobile";
...
if ($stmt_check->rowCount() > 0) {
    ...
    // Insert the new candidate record into the candidate_2nd table
    $sql = "INSERT INTO candidate_2nd (name, email, mobile, branch, rollno, enrollid) 
