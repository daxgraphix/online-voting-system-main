...
$sql_check = "SELECT * FROM candidate_3rd WHERE email = :email OR mobile = :mobile";
...
if ($stmt_check->rowCount() > 0) {
    ...
    // Insert the new candidate record into the candidate_3rd table
    $sql = "INSERT INTO candidate_3rd (name, email, mobile, branch, rollno, enrollid) 
